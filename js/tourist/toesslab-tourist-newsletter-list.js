 ...
 * File: /packages/toess_lab_news_letter/js/tourist/toesslab-tourist-newsletter-list.js
 */
...
$(function () {
    ...
    var tour,
        steps = [{
            content: '<p><span class="h5">' + window.tourist_edit_newsletter_title + '</span>:<br/>' + window.tourist_edit_newsletter_text + '</p>',
            ...
            {
                content: '<p><span class="h5">' + window.tourist_new_newsletter_title + '</span>:<br/>' + window.tourist_new_newsletter_text + '</p>',
                highlightTarget: true,
                nextButton: true,
                target: $('#add_new'),
                my: 'top center',
